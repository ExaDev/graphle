...
describe('Graph Component', () => {
  ...
  it('renders without crashing', () => {
    render(<Graph project={project} view={view} onProjectChange={() => {}} onViewChange={() => {}} />);
  ...
  it('adds an edge', () => {
    ...
    expect(screen.getByText('Edge from undefined to undefined')).toBeInTheDocument();
  });
  ...
  it('removes an edge', () => {
    ...
    expect(screen.queryByText('Edge from undefined to undefined')).not.toBeInTheDocument();
  });
